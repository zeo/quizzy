                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            <a href="#" class="border-indigo-500 text-gray-900 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium" aria-current="page">Quizzes</a>

                            <a href="#" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium"> Team </a></div>
                    </div>
                    <div class="hidden sm:ml-6 sm:flex sm:items-center space-x-5">
                        <tippy v-if="!user?.has_verified_email" content="You have not verified your email yet!">
                            <inertia-link href="/account/settings">
                                <fontawesome-icon icon="far fa-triangle-exclamation" class="w-5 h-5 text-amber-400" />
                            </inertia-link>
                        </tippy>
                        ...
                        <DropdownMenu>
                            <template #toggle="{ toggle }">
                                <button
                                    @click="toggle"
                                    type="button"
                                    class="max-w-xs flex items-center rounded-full focus:outline-none"
                                >
                            ...
                            <DropdownItem href="/dashboard/quizzes" icon="far fa-square-question">Your quizzes</DropdownItem>
                            <DropdownItem href="/dashboard/profile" icon="far fa-user">Your profile</DropdownItem>
                            <DropdownItem href="/auth/logout" method="post" as="button" icon="far fa-arrow-right-to-bracket" class="w-full">Logout</DropdownItem>
                        </DropdownMenu>
                    </div>
